...
const CHART_COLORS = {
  ...
  "Core City": "#AD1457",
  "Developed Community": "#827717",
  "Growing Suburb": "#4E342E",
  "Rural Area": "#4527A0",
};
      ...
      >
        ...
        {config.locations.map((location) => (
          <Line
            ...
            name={location.name}
            stroke={CHART_COLORS[location.name]} // This matches the config name
            strokeWidth={2}
            dot={{
              r: 4,
              strokeWidth: 2,
...
export default CommunityIntegrationChart2;
